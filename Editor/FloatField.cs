...
public class GenerateSettings:EditorWindow
{
    ...
    private void OnGUI()
    {
        ...
        {
            case settings.MAGE:
                DrawSettings((EnemySample)EnemyDesignerWindow.mage_info);
                break;
            case settings.WARRIOR:
                DrawSettings((EnemySample)EnemyDesignerWindow.warrior_info);
                break;
            case settings.ROGUE:
                DrawSettings((EnemySample)EnemyDesignerWindow.rogue_info);
                break;
        }
    }
